...
```
以上两种代码在单线程的情况下是没问题的，但是在多线程的情况就会有可能出现问题。
<font color="red">*在重现问题之前，首先要学会多线程debug。</font>
...
2.     @Override
3.     public void run() {
4.         HungrySingleton hungrySingleton = HungrySingleton.getInstance();
5.         System.out.println(Thread.currentThread().getName() + "  " + hungrySingleton);
6.     }
7. }
```
```java
