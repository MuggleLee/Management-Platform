...
public abstract class Component {
    ...
    void addDepartment(Department department) { throw new UnsupportedOperationException("不支持添加部门操作"); }
    ...
    Department getDepartment() { throw new UnsupportedOperationException("不支持获取部门操作"); }
